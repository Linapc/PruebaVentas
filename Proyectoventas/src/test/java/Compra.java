...
public class Compra {
    ...
    public void hacer_una_compra() {
        ...
        WebElement botonCerrarCompra = firefoxDriver.findElement(By.xpath("//span[contains(text(),'Proceed to checkout')]"));
